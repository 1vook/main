...
// ============================================================================
function* generateEvenNumbers(count: number) {
...
const courseStudentsCount = new Map<number, number>()

for (const student of students) {
  courseStudentsCount.set(
    student.course,
    (courseStudentsCount.get(student.course) || 0) + 1,
  )
}
...
const intersection = new Set(
  [...historyClub].filter((student) => mathClub.has(student)),
)
